        ...
        <?php foreach( $posts as $post ) { ?>
          <div class="blog-post">
            ...
            <p class="blog-post-meta">
                <?php echo $post['post-date']; ?> by <?php echo $post['post-author']; ?>
            </p>
            <p>
